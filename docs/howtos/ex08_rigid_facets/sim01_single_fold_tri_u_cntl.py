...
Use displacement control to fold two-facet element
--------------------------------------------------

Two triangular facets connected with a single fold line.
One facet is fixed. The free node of the other facet
is moved upwards. 
'''
