...
if __name__ == '__main__':
    ...
    unit_mlo = np.einsum('...j,...k,...ijk->...i',
                         unit_vl, unit_nl0, EPS)
    print'unit_mlo', unit_mlo
    ...
    unit_ml0_dul0_part1 = np.einsum(
        '...j,...kNd,...ijk->...iNd',
        unit_vl, unit_nl0_dul0, EPS)

    print 'unit_ml0_dul0_part1', unit_ml0_dul0_part1.shape
    print unit_ml0_dul0_part1
